        ...
        <div class="fade-in">
            <div class="text-center mb-4">
                <a href="" class="text-dark text-decoration-none">
                    <img src="/image/cash-machine.png" width="70" alt="">
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                            <div class="input-group mb-3">
                                ...
                                <input type="email" v-model="form.email" :class="{ 'is-invalid': errors.email }" class="form-control" placeholder="Email Address">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" v-model="form.password_confirmation" :class="{ 'is-invalid': errors.password_confirmation }" placeholder="Confirm Password">
                            </div>
                            <div class="row">
                                <div class="col-12">
